...
class AverageMeter(object):
    ...
    def initialize(self, val, weight):
        self.val = val   #0.7268214821815491
        self.avg = val   #0.7268214821815491
        self.sum = np.multiply(val, weight)  #0.7268214821815491
        self.count = weight  # 1
...
def get_metrics(predict, target, threshold=None, predict_b=None,running_auc=None):
    ...
    if torch.is_tensor(target):
        ...
        target = target.flatten()   #tuple(1,)    (4608,)
